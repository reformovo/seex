...
Install the Python beta with `pip install seex==0.1.0b3`, or add the Rust SDK
with `cargo add seex@0.1.0-beta.3`.
...
[0.1.0b3 release notes](docs/release-notes/0.1.0b3.md) for validation details
